...
class WatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create watch" do
    assert_difference("Watch.count") do
      post watches_url, params: { watch: { brand: @watch.brand, price: @watch.price, year: @watch.year } }
    end
  ...
  test "should update watch" do
    patch watch_url(@watch), params: { watch: { brand: @watch.brand, price: @watch.price, year: @watch.year } }
